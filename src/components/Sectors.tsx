    ...
    <Section id="sectoren" className="bg-ink text-white">
      <div className="grid gap-12 lg:grid-cols-[0.8fr_1fr] lg:items-start">
        <div>
          ...
          <h2 className="mt-3 text-3xl font-bold leading-tight tracking-normal sm:text-4xl">Gebouwd voor organisaties die financieel vertrouwen willen opschalen.</h2>
          <p className="mt-5 text-lg leading-8 text-slate-300">
            Van enterprise distributie tot directe consumentenervaringen: Finstri ontwerpt planningstechnologie voor markten waar precisie, adoptie en veiligheid samenkomen.
          </p>
        </div>

        <div className="grid gap-4">
          {sectors.map(({ icon: Icon, label, text }) => (
            <article key={label} className="rounded-lg border border-white/10 bg-white/[0.06] p-6 transition duration-200 hover:-translate-y-1 hover:border-mint/35 hover:bg-white/[0.09]">
